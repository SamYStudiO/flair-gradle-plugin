...
package starling.geom
{
	...
	public class Polygon
	{
		...
		public function copyToVertexData( target : VertexData , targetIndex : int = 0 ) : void
		{
			...
			copyToVector( target.rawData , targetIndex * VertexData.ELEMENTS_PER_VERTEX , VertexData.ELEMENTS_PER_VERTEX - 2 );
		}
		...
		public function toString() : String
		{
			...
			{
				result += "  [Vertex " + i + ": " + "x=" + mCoords[ i * 2 ].toFixed( 1 ) + ", " + "y=" + mCoords[ i * 2 + 1 ].toFixed( 1 ) + "]" + (i == numPoints - 1 ? "\n" : ",\n");
			}
