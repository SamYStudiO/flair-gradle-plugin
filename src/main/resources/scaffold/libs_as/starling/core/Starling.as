...
package starling.core
{
     ...
     */ public class Starling extends EventDispatcher
    {
        ...
        private static var sAll : Vector.<Starling> = new <Starling>[]; // starling.display.stage!
        ...
        public function render() : void
        {
            ...
            mSupport.setProjectionMatrix( mViewPort.x < 0 ? -mViewPort.x / scaleX : 0.0 , mViewPort.y < 0 ? -mViewPort.y / scaleY : 0.0 , mClippedViewPort.width / scaleX , mClippedViewPort.height / scaleY , mStage.stageWidth , mStage.stageHeight , mStage.cameraPosition );
