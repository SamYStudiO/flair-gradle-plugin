...
package starling.core
{
    ...
    public class RenderSupport
    {
        ...
        {
            Starling.context.clear( Color.getRed( rgb ) / 255.0 , Color.getGreen( rgb ) / 255.0 , Color.getBlue( rgb ) / 255.0 , alpha );
        }
        ...
        public function pushMask( mask : DisplayObject ) : void
        {
            ...
            context.setStencilActions( Context3DTriangleFace.FRONT_AND_BACK , Context3DCompareMode.EQUAL , Context3DStencilAction.KEEP );
        }
        ...
        public function popMask() : void
        {
            ...
            context.setStencilActions( Context3DTriangleFace.FRONT_AND_BACK , Context3DCompareMode.EQUAL , Context3DStencilAction.DECREMENT_SATURATE );
        ...
        {
            if( mQuadBatches[ mCurrentQuadBatchID ].isStateChange( quadBatch.tinted , parentAlpha , quadBatch.texture , quadBatch.smoothing , mBlendMode , quadBatch.numQuads ) )
            {
                finishQuadBatch();
            }
