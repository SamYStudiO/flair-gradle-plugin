...
package starling.display
{
     ...
     */ public class DisplayObject extends EventDispatcher
    {
        ...
        public function set transformationMatrix( matrix : Matrix ) : void
        {
            ...
            mScaleY = (mSkewX > -PI_Q && mSkewX < PI_Q) ? matrix.d / Math.cos( mSkewX ) : -matrix.c / Math.sin( mSkewX );
            mScaleX = (mSkewY > -PI_Q && mSkewY < PI_Q) ? matrix.a / Math.cos( mSkewY ) : matrix.b / Math.sin( mSkewY );
