...
package starling.filters
{
    ...
    public class FragmentFilter
    {
        ...
        private const MIN_TEXTURE_SIZE : int = 64;  // pass texture coordinates to fragment program
        private var mVertexPosAtID : int = 0; // just forward texture color
        ...
        private function renderPasses( object : DisplayObject , support : RenderSupport , parentAlpha : Number , intoCache : Boolean = false ) : QuadBatch
        {
            ...
            if( intoCache )
                cacheTexture = Texture.empty( boundsPot.width , boundsPot.height , PMA , false , true , mResolution * scale );
