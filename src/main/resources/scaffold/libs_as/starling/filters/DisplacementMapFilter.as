    ...
    public class DisplacementMapFilter extends FragmentFilter
    {
        ...
        protected override function createPrograms() : void
        {
            ...
            else
            {
                ...
                var vertexShader : String = [ "m44  op, va0, vc0" , // 4x4 matrix transform to output space
                ...
                var fragmentShader : String = [ "tex ft0,  v1, fs1 " + mapFlags , // read map texture
                ...
                mShaderProgram = target.registerProgramFromSource( programName , vertexShader , fragmentShader );
            }
        }
