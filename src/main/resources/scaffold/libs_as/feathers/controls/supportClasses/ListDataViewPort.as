...
package feathers.controls.supportClasses
{
	...
	public class ListDataViewPort extends FeathersControl implements IViewPort
	{
		...
		private function findUnrenderedData() : void
		{
			...
			if( useVirtualLayout && this._typicalItemIsInDataProvider && this._typicalItemRenderer && HELPER_VECTOR.indexOf( this._typicalItemRenderer.index ) >= 0 )
			{
			...
			var canUseBeforeAndAfter : Boolean = this._layout is ITrimmedVirtualLayout && useVirtualLayout && (!(this._layout is IVariableVirtualLayout) || !IVariableVirtualLayout( this._layout ).hasVariableItemDimensions) && unrenderedItemCount > 0;
