...
package feathers.controls.supportClasses
{
	...
	public class LayoutViewPort extends LayoutGroup implements IViewPort
	{
		...
		override protected function refreshViewPortBounds() : void
		{
			...
			if( this._autoSizeMode == AUTO_SIZE_MODE_STAGE && this._explicitVisibleWidth !== this._explicitVisibleWidth )
			{
			...
			if( this._autoSizeMode == AUTO_SIZE_MODE_STAGE && this._explicitVisibleHeight !== this._explicitVisibleHeight )
			{
