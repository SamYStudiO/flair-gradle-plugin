...
{
	import _appId_.motion.transitions.SlideTransitionManager;
	 ...
	 */
	public class AAssetNavigatorPanelScreen extends AAssetScreen implements INavigatorScreen
	{
		/**
		 *
		 */
		 ...
		 *
		 */
		public function AAssetNavigatorPanelScreen()
		{
			super();
