...
public final class SDKManager
{
	...
	public static String getPath( Project project )
	{
		...
		if( !local.exists( ) ) throw new MissingPropertyException( "local.properties file is missing, add it to your project root" )
		...
		if( path == null || path.isEmpty( ) ) throw new MissingPropertyException( "sdk.dir property is missing or empty from your local.properties file" )
