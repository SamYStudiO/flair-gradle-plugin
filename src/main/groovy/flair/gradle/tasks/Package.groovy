...
class Package extends AbstractVariantTask
{
	...
	public void setVariant( Variant variant )
	{
		...
		outputFile = project.file( "${ outputVariantDir }/package/${ project.name }_${ variant.getProductFlavorsBuildTypeWithType( Variant.NamingTypes.UNDERSCORE ) }_${ version }.${ getExtension( ) }" )
	}
