...
public class IOSPlugin extends AbstractPlugin
{
	public void addTasks()
	{
		...
		addTask( Tasks.PROCESS_IOS_RESOURCES.name , Tasks.PROCESS_IOS_RESOURCES.type )
		addTask( Tasks.PROCESS_PROD_IOS_RESOURCES.name , Tasks.PROCESS_PROD_IOS_RESOURCES.type )
